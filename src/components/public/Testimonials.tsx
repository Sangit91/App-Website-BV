  ...
  return (
    <section id="phan-hoi" className="bg-mint py-16 md:py-20 border-b border-green-800/10">
      <div className="max-w-[1180px] mx-auto px-4">
        ...
        {/* Section Heading */}
        <ScrollAnimation animation="fade-up" className="text-center max-w-[680px] mx-auto mb-12 md:mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {TESTIMONIALS.map((testi, idx) => (
            <ScrollAnimation key={testi.id} animation="fade-up" delay={idx * 0.1} className="h-full">
              <div
                className="bg-white border border-green-800/5 p-6 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between text-left relative group overflow-hidden cursor-pointer hover:border-brand-green/30 h-full"
              >
