          ...
          {navItems.map((item) => (
            ...
            >
              <button
                ...
                className={`px-3 py-1.5 rounded-full text-[13px] xl:text-[14px] font-sans font-semibold whitespace-nowrap cursor-pointer flex items-center gap-1 focus:outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-green/40 focus-visible:rounded-full ${
