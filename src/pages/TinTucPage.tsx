          ...
          {activeTab === "tuyen-dung" && (
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
              <div className="text-center max-w-[680px] mx-auto mb-10">
                <h2 className="font-display font-bold text-2xl text-green-dark mb-4">Tuyển dụng</h2>
                <p className="text-ink/70">Cơ hội nghề nghiệp tại Bệnh viện Đa Khoa Khu Vực Miền Núi Phía Bắc Quảng Nam</p>
              </div>
